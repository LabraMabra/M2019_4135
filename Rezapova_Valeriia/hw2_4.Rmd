...
```{r}
set.seed(3)
bag.boston=randomForest(medv~.,data=TrainSet,mtry=7, importance=TRUE)
...
boost.boston=gbm(medv~.,data=TrainSet,distribution="gaussian",n.trees=1000,interaction.depth=4,shrinkage=0.02,verbose=F)
