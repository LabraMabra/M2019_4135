...
abline(h = median_builtin_x + iqr_x, col="orange")
abline(h = median_builtin_x - iqr_x, col="orange")
...
abline(h = median_builtin_outl + iqr_outl, col="orange")
abline(h = median_builtin_outl - iqr_outl, col="orange")
abline(h = mean_builtin_outl + sd_outl, col="red")
abline(h = mean_builtin_outl - sd_outl, col="red")
```
(mean_builtin_outl + sd_outl) is outside of the plot.
...
plot <- function(sample_id) {
  info <- prop_df[[sample_id]]
  ggplot() +
    aes(info[4:13]) +
    geom_density() +
    geom_vline(aes(xintercept=info[[1]], color="mean")) +
    geom_vline(aes(xintercept=info[[2]], color="var")) +
    geom_vline(aes(xintercept=info[[3]], color="sd")) +
    xlab(sample_id)
}
...
plot <- function(k) {
  ggplot() +
    ...
    geom_vline(aes(xintercept=stat[stat$k == k, 4], color="SE")) +
