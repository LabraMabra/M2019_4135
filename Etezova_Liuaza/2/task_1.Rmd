...
lapply(airq_l[, !(names(airq_l) %in% c('Date', 'Time', 'C6H6.GT.', 'T', 'RH', 'AH'))], 
       benzene_lm_summary)
```

### Selected predictors
PT08.S2(NMHC) {PT08.S2(NMHC)^2 after linearizing} - titanium dioxide (R^2 = 0.9996),
CO(GT) - carbon monoxide (R^2 = 0.8669), 
NMHC(GT) {NMHC(GT)^0.7 after linearizing} - nonmethane hydrocarbons (R^2 = 0.8488).
```{r}
set.seed(42)
